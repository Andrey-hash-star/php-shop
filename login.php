    ...
    if (empty($errors)) {
        ...
        if ($user) {
            if (password_verify($password, $user['password'])) {
                $_SESSION['loggetUser'] = $user;
                die(header('Location:/'));
            } else {
                $echo_alert = "<div class='alert alert-danger' role='alert'>Неверный логин или пароль!</div><hr>";
            }
        } else {
            $echo_alert = "<div class='alert alert-danger' role='alert'>Неверный логин или пароль!</div><hr>";
        }
    ...
    <main role="main" class="flex-shrink-0 mt-5">
        ...
        <div class="container">
            ...
            <form action="/login.php" method="post">
                ...
                <button type="submit" name="do_login" class="btn btn-success mt-3 mb-3">Войти</button>
            </form>
        </div>
    </main>
